...
static const struct processing_id __maybe_unused processing_ids[] = {
	...
	/* Some of these may not be complete, but for testing with
	 * pkcs11-tool set them to supported TODO G */
	SKS_PROCESSING_ID(SKS_CKM_RSA_PKCS_KEY_PAIR_GEN),
	SKS_UNSUPPORTED_PROCESSING_ID(SKS_CKM_RSA_PKCS),
	SKS_PROCESSING_ID(SKS_CKM_RSA_9796),
	SKS_PROCESSING_ID(SKS_CKM_RSA_X_509),
	...
	SKS_PROCESSING_ID(SKS_CKM_RSA_AES_KEY_WRAP),
